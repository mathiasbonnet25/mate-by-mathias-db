  ...
  return (
    <form onSubmit={onSubmit} className="max-w-sm space-y-5 rounded-lg border border-line p-7">
      ...
      <button
        type="submit"
        disabled={pending}
        className="rounded-full inline-flex items-center gap-2 bg-foreground px-7 py-3 text-[11px] uppercase tracking-[0.16em] text-surface transition-all hover:bg-accent hover:text-accent-contrast disabled:opacity-50"
      >
