...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${siteUrl}/comment-ca-marche`, changeFrequency: "monthly", priority: 0.7 },
    { url: `${siteUrl}/livraison`, changeFrequency: "monthly", priority: 0.5 },
    { url: `${siteUrl}/retours-remboursements`, changeFrequency: "monthly", priority: 0.5 },
    { url: `${siteUrl}/garanties`, changeFrequency: "monthly", priority: 0.5 },
    { url: `${siteUrl}/reclamations`, changeFrequency: "monthly", priority: 0.5 },
    { url: `${siteUrl}/informations-legales`, changeFrequency: "monthly", priority: 0.4 },
